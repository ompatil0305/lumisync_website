      ...
      <main className="flex-1 bg-[--background] pt-28 pb-20">
        <div className="section-max px-6 max-w-3xl">
          <div className="prose mx-auto">
            ...
            <h2 className="text-xl font-bold font-display text-stone-900 dark:text-stone-50 mt-8 mb-4">3. AI Data Handling</h2>
            <p className="text-sm leading-relaxed mb-6">
            ...
            <h2 className="text-xl font-bold font-display text-stone-900 dark:text-stone-50 mt-8 mb-4">4. Compliance & FERPA</h2>
            <p className="text-sm leading-relaxed mb-6">
