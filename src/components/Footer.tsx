...
export default function Footer() {
  return (
    <footer className="bg-stone-950 text-stone-400 border-t border-stone-900 pt-20 pb-12">
      <div className="section-max">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-16">
          {/* Brand Info */}
          <div className="col-span-2">
            <Link href="/" className="inline-block mb-6">
              <Logo size={28} variant="full" className="text-white fill-white" />
            </Link>
            ...
            <div className="flex gap-4 mt-6">
              <a
                ...
                aria-label="GitHub"
                className="w-9 h-9 rounded-full bg-stone-900 hover:bg-stone-850 flex items-center justify-center text-stone-300 hover:text-white transition-colors"
              >
          ...
          {/* Product Links */}
          <div>
            <h3 className="text-[11px] font-bold text-stone-500 uppercase tracking-widest mb-4">Product</h3>
          ...
          {/* For Audience Links */}
          <div>
            <h3 className="text-[11px] font-bold text-stone-500 uppercase tracking-widest mb-4">For</h3>
            <ul className="space-y-2.5">
              {forLinks.map((link) => (
                <li key={link.label}>
                  <Link href={link.href} className="text-[13px] hover:text-white transition-colors">
          ...
          {/* Company & Resources */}
          <div>
            <h3 className="text-[11px] font-bold text-stone-500 uppercase tracking-widest mb-4">Resources</h3>
            <ul className="space-y-2.5">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8 border-t border-stone-900 text-xs text-stone-500">
          <p>© {new Date().getFullYear()} Lumisync Inc. All rights reserved.</p>
